        ...
        <div className={styles.header}>
          <div className={styles.headerChapterData}>
            ...
            <h1 className={styles.headerChapterTitle}>
              Глава {selectedChapter.ChapterId}
            </h1>
          </div>
