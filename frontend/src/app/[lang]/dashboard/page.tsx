  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.greeting} aria-label={t("greetingAria")}>
        <p className={styles.greetingHi}>{t("greetingHi", { name })}</p>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.statCard}>
          ...
          {!lastRead ? (
            <span className={styles.lastMuted}>{t("lastReadHint")}</span>
          ) : null}
        </div>
      </header>
            ...
            {recentNotes.map((note) => (
              <li key={note.id}>
                <Link href="/verse-notes" className={styles.feedLink} prefetch>
                  ...
                  <div className={styles.feedNoteSnippet}>
                    {note.sourceText}
                  </div>
