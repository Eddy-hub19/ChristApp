...
export default function LoginServerWarmupPanel({
  enabled = true,
}: LoginServerWarmupPanelProps) {
  const t = useTranslations("login");
  const { reachable, checking, elapsedLabel, hint, showPanel } =
    useBackendWarmupStatus(enabled);
