...
export default function ProfileChaptersCard() {
  ...
  const { readCount, fraction, lastRead, remainingToFullCanon } =
    useBibleReadingProgressSnapshot();
    ...
    >
      ...
      >
        <div className={styles.ringWrap}>
          ...
          <div
            className={`${styles.iconInRing} ${hasProgress ? styles.iconInRingMature : ""}`}
          >
            <Image
              className={styles.chaptersIconImg}
              src="/icon-chapters.svg"
              alt=""
              width={14}
              height={14}
            />
