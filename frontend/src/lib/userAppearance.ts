...
export function normalizeThemeFontKey(
...
export function applyUserAppearanceToDocument(
  user: UserAppearanceFields | null | undefined,
): void {
  ...
  if (fontKey === "achiko") {
    document.body.style.fontFamily =
      '"Achiko", "Inter", ui-sans-serif, system-ui, sans-serif';
